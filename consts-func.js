...
const sshlink = JSON.parse(fs.readFileSync('./logos/ssh.json'))

const sshlink2 = JSON.parse(fs.readFileSync('./logos/ssh2.json'))

const sshlink3 = JSON.parse(fs.readFileSync('./logos/smm2.json'))
...
const { revender } = require('./armor/js/revender');

const { regras } = require('./armor/js/regras');

const { flyer } = require('./armor/js/flyer');

const { app } = require('./armor/js/app');

const { menuadulto } = require('./armor/js/menuadulto');

const { sshgratis } = require('./armor/js/sshgratis');

const { smm } = require('./armor/js/smm');
